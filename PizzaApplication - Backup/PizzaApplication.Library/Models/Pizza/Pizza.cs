...
namespace PizzaApplication.Library
{
    public class Pizza
    {
        ...
        public void BuildToppingList()
        {
            ToppingList = new List<Topping>();
            if (Topping1 != null) ToppingList.Add(new Topping(Topping1));
            if (Topping2 != null) ToppingList.Add(new Topping(Topping2));
            if (Topping3 != null) ToppingList.Add(new Topping(Topping3));
            if (Topping4 != null) ToppingList.Add(new Topping(Topping4));
            if (Topping5 != null) ToppingList.Add(new Topping(Topping5));
            if (Topping6 != null) ToppingList.Add(new Topping(Topping6));
        }
