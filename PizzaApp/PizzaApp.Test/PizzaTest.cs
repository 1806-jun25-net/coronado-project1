...
namespace PizzaApp.Test
{
    public class PizzaTest
    {
        ...
        public void ShouldNotBeAbleToOrderPizzaIfItExceedsOrderPriceLimit()
        {
            ...
            testPizza.Price = 501.00m; // set price of pizza to over limit: $501.00
            ...
            var addedPrice = testPizza.Price;
            var totalPrice = testOrder.Price;
        ...
        {
            var customer = new User("Test", "Person");
            var storefront = new Location("Test Location");
            var testPizza = new Pizza();

            storefront.Inventory.Dough = 0;
            ...
            {
                if (storefront.Inventory.CheckIfInventoryIsSufficient(ingredient))
                {
                    storefront.Inventory.DeductInventoryCount(ingredient);
                }
                else
                {
